...
function atualizarProgresso(valor){
    ...
    const larguraDisponivel =
        jornada.clientWidth - larguraRunner - 45;
    ...
    if (progresso < 33) {
        texto.innerHTML =
        'Início da jornada...'; // Equipando a bombeira...
...
donations.forEach(card => {
    ...
    card.addEventListener("click", () => {
        ...
        if(valor === 0){
            ...
            pixMessage.innerHTML =
            "Você decidiu escolher outro valor. Qualquer ajuda é muito bem-vinda! ❤️";
            ...
            pixMessage.innerHTML = `
                Você escolheu fortalecer a missão com
                <strong>R$ ${valor}</strong>.<br><br>

                <strong>${fraseAleatoria()}</strong>
            `;
